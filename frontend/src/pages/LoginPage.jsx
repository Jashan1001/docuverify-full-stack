  ...
  return (
    <div className="min-h-screen bg-paper grid-cross flex">
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-ink border-r-3 border-ink p-12">
        ...
        <div>
          ...
          <div className="space-y-4">
            {[
              [
                "SHA-256 Hashing",
                "Every document cryptographically fingerprinted",
              ],
              ...
              [
                ...
                "Every state change permanently recorded",
              ],
            ].map(([title, desc]) => (
              <div key={title} className="border-l-3 border-accent pl-4">
                <div className="font-mono text-sm font-medium text-paper">
                  {title}
                </div>
        ...
        <div>
          <div className="font-mono text-xs text-muted mb-3 border-t border-muted pt-4">
            Seeded admin
          </div>
          <div className="font-mono text-xs text-accent">
            admin@docuverify.com
          </div>
          <div className="font-mono text-xs text-muted">
            Use configured SEEDER_ADMIN_PASSWORD
          </div>
        </div>
      </div>
